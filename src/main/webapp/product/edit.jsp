        ...
        <div class="span9">
            ...
            <div class="well">
                <form class="form-horizontal" method="post">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="image">Hình ảnh<sup>*</sup></label>
                        <div class="controls">
                            <input type="text" id="image" value="${product.image}" name="image">
                        </div>
                    </div>
...
<%--                            <textarea rows="9" cols="70" id="description" name="description">${product.description}</textarea>--%>
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <input type="submit" name="submitAccount" value="Cập nhật sản phẩm" class="exclusive shopBtn">
                        </div>
                    </div>
                </form>
            </div>
