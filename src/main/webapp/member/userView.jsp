    ...
    <div class="container">
      <div class="alignR">
        ...
        <c:if test="${sessionScope.acc != null}">
          <a href="/logout"><span class="icon-edit"></span>Logout</a>
          <a href="#"><span class="icon-user"></span> ${acc.username}</a>
        </c:if>
        <c:if test="${sessionScope.acc == null}">
              ...
              <li class="span4" style="margin: 0 !important; padding: 5px">
                <div class="thumbnail">
                  ...
                  <div class="caption cntr">
                    ...
                    <h4><a class="shopBtn" href="/Cart?action=addToCart&id=${product.id}&username=${username}" title="add to cart"> Add to
                      cart1000</a></h4>
